...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Variables ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
listamenu=["opciones:","1) selec Wlan & changer Mac" ,"2) Scaner red ", "3) Crack rainbow","4) Exit"]#Menu Princcipal
key=0
exit=False
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ OPciones MEnu ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
def menu():
...
def scan(wlan):
		while True:
			try:
				dic=input("Quiere procesar diccionario personal: ")
				if(dic=='y'):
					wordlist=input("Introduzca ruta y nombre: ")
					os.system('airolib-ng raibonw-db --import passwd '+wordlist)
				else:
					os.system('airolib-ng raibonw-db --import passwd wordlist')			
				...
				file.write(ESSID)
				file.close()
				os.system('airolib-ng rainbow-db --import essid essidfile')
				break
			except TypeError:
				print("Failed")
def attack():
	os.system('airolib-ng rainbow-db --batch')
	cap=input("Introduzca file.cap: ")
	os.system('aircrack-ng -r rainbow-db '+cap)
